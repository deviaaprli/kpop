...
<body>
    <header class="header">
        ...
        <div id="shopping-cart" class="shopping-cart">
            ...
            <div><button class="co-btn" onclick="window.location.href='checkout.php'">Checkout</button></div>
        </div>
    </header>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <p>Stok: 10</p>
                        <div class="orderNow">
                            <button onclick="addItem('LightStick Ofc Treasure','700000', '1.5')">Add To Cart</button>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <p>Stok: 5</p>
                        <div class="orderNow">
                            <button onclick="addItem('Collection Book 2P PVC','30000', '0.5')">Add To Cart</button>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <p>Stok: 10</p>
                        <div class="orderNow">
                            <button onclick="addItem('Collection Book Daiso','50000', '0.5')">Add To Cart</button>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <div class="orderNow">
                            ...
                            <button onclick="addItem('Treasure Reboot Album','150000', '2.5')">Add To Cart</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <div class="orderNow">
                            ...
                            <button onclick="addItem('Blackpink Album HYLT','200000', '1.5')">Add To Cart</button>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <p>Stok: 10</p>
                        <div class="orderNow">
                            <button onclick="addItem('LightStick Blackpink V2','750000', '1.25')">Add To Cart</button>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <div class="orderNow">
                            ...
                            <button onclick="addItem('New Jeans BBB Album','230000', '2')">Add To Cart</button>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide box">
                    ...
                    <div class="product-content">
                        ...
                        <p>Stok: 15</p>
                        <div class="orderNow">
                            <button onclick="addItem('Custom Card Holder Akrilik','75000', '0.5')">Add To Cart</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="https://unpkg.com/swiper/swiper-bundle.min.php"></script>
